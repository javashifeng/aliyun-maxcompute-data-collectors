...
public class RecordParser {
  ...
  public Map parseRecord(Record input)
    ...
    for (int i = 0; i < columns.length; i++) {
      ...
      switch (columns[i].getType()) {
        case BIGINT: {
          Long v = input.getBigint(i);
          colValue = v == null ? null : v.toString();
          break;
        }
        case BOOLEAN: {
          Boolean v = input.getBoolean(i);
          colValue = v == null ? null : v.toString();
          break;
        }
        case DATETIME: {
        ...
        case STRING: {
          String v = input.getString(i);
          colValue = v == null ? null : v.toString();
          break;
        }
        case DECIMAL: {
          BigDecimal v = input.getDecimal(i);
          colValue = v == null ? null : v.toString();
          break;
        }
        default:
      ...
      res.put(columns[i].getName(), colValue);
    }
    return res;
  }
