...
public class ExportTool extends com.cloudera.sqoop.tool.BaseSqoopTool {
  ...
  protected RelatedOptions getOdpsOptions() {
    RelatedOptions odpsOpts = new RelatedOptions("ODPS export arguments");
    odpsOpts.addOption(OptionBuilder.withArgName("table")
        .hasArg()
        .withDescription("Export <table> in ODPS")
    ...
    odpsOpts.addOption(OptionBuilder.withArgName("partitionSpec")
        ...
        .withLongOpt(ODPS_PARTITION_SPEC_ARG)
        .create());
    return odpsOpts;
  }
  ...
  public void configureOptions(ToolOptions toolOptions) {
    ...
    toolOptions.addUniqueOptions(getOdpsOptions());
  }
  ...
  protected void validateExportOptions(SqoopOptions options)
    ...
    if (options.getTableName() == null && options.getCall() == null) {
      ...
      && options.getOdpsTable() == null) {
      throw new InvalidOptionsException(
          "Export requires an --export-dir argument or "
          + "--hcatalog-table argument or --odps-table argument."
          + HELP_STR);
